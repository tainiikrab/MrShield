...
public class Projectile : AbstractDamageDealer, IHasTarget
{
    ...
    public void Initialize(Transform target, ShootingEnemyController shootingEnemyController, Vector3 initialVelocity)
    {
        _time = 0f;
        _startPos = transform.position;
        Target = target;
        _shootingEnemyController = shootingEnemyController;
    ...
    private void OnHit(RaycastHit hit)
    {
        ...
        {
            if (_shootingEnemyController != null)
                _shootingEnemyController.ReflectProjectile(this);
            else
                Destroy(gameObject);
    ...
    private IEnumerator DestroyProjectile()
    {
        ...
        _shootingEnemyController.RemoveProjectile(this);
        Destroy(gameObject);
    }
}